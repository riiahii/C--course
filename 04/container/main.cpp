...
bool same_values(std::vector< int >& ints)
{
    ...
    {
        if (ints.at(item - 1) == ints.at(item))
        {
           is_it = true;
        }
        else
...
bool is_arithmetic_series(std::vector< int >& ints)
{
    ...
    {
        if (ints.at(item) - ints.at(item - 1) == ints.at(item - 1) - ints.at(item - 2))
        {
           is_it = true;
        }
        else
...
bool is_geometric_series(std::vector< int >& ints)
{
    ...
    for ( int item = 2; item < size; ++item)
    {
        ...
        else if (ints.at(item) / ints.at(item - 1) == ints.at(item - 1) / ints.at(item - 2))
        {
           is_it = true;
        }
        else
